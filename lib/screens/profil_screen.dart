...
class ProfilScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalTransaksi = AppData.daftarTransaksi.length;
    final totalRekening = AppData.daftarRekening.length;
    final pemasukan = AppData.totalPemasukan(now.month, now.year);
    final pengeluaran = AppData.totalPengeluaran(now.month, now.year);
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoCard(
                  ...
                  label: 'Nama Lengkap',
                  value: AppData.namaUser,
                ),
                const SizedBox(height: 10),
                _buildInfoCard(
                  icon: Icons.email_outlined,
                  label: 'Email',
                  value: AppData.emailUser,
                ),
                const SizedBox(height: 10),
                _buildInfoCard(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 14),
                      const Text(
                        'Aplikasi pencatatan keuangan yang dirancang khusus untuk mahasiswa. '
                        'Mudah digunakan untuk mencatat pemasukan, pengeluaran, dan memantau saldo rekening.',
                        style: TextStyle(
                          color: Colors.grey,
                          fontSize: 13,
                          height: 1.5,
